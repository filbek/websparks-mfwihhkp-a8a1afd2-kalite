    ...
    return (
      <div className="text-center py-12">
        <div className="w-24 h-24 bg-secondary-100 dark:bg-secondary-800 rounded-full flex items-center justify-center mx-auto mb-4">
          <i className="bi bi-file-earmark text-4xl text-secondary-400 dark:text-secondary-500"></i>
        </div>
        <h3 className="text-lg font-medium text-secondary-900 dark:text-white mb-2">Doküman Bulunamadı</h3>
        <p className="text-secondary-600 dark:text-secondary-400">Arama kriterlerinize uygun doküman bulunamadı.</p>
      </div>
    );
  }
