/*
  # Multi-Tenant Data Isolation Migration (Fixed)
  ...
  ## Düzeltme
  - Helper function 'auth' şeması yerine 'public' şemasında oluşturuldu.
*/
...
USING (
  organization_id = public.get_current_org_id() -- Temel İzolasyon
  AND (
...
USING (
  organization_id = public.get_current_org_id()
  -- Kendini her zaman görebilsin (gerekli olabilir)
  OR id = auth.uid()
);
