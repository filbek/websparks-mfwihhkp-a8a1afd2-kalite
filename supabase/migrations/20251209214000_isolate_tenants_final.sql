/*
  # Multi-Tenant Data Isolation MIGRATION (Final)
  
  ## Adımlar
  1. dofs tablosuna organization_id ekle ve doldur.
  2. Helper function oluştur.
  3. Tüm RLS politikalarını güncelle.
*/
...
ALTER TABLE dofs ALTER COLUMN organization_id SET NOT NULL;
